...
export default function AuthForm({ isLogin }: Props) {
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
                <label htmlFor="email" className="block text-sm font-medium text-stone-700 dark:text-stone-200 mb-1.5">
                    Email Address
                </label>
                <input
                    id="email"
            ...
            <div>
                <label htmlFor="password" className="block text-sm font-medium text-stone-700 dark:text-stone-200 mb-1.5">
                    Password
                </label>
                <input
                    id="password"
            ...
            {isLogin && (
                <div className="flex items-center justify-between text-sm pt-1">
                    <div className="flex items-center">
                        ...
                        />
                        <label htmlFor="remember-me" className="ml-2 block text-stone-700 dark:text-stone-400">
                            Remember me
                        </label>
                    </div>
                    <Link href="/forgot-password" className="font-medium text-stone-900 dark:text-stone-300 hover:underline">
                        Forgot password?
                    </Link>
                </div>
            )}
